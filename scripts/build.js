...
const required = ['public/index.html', 'public/styles.css', 'public/prompt-engine.js', 'public/app.js', 'public/manifest.webmanifest', 'public/d9-logo.png', 'public/d9-logo-white.png', 'public/assets/business-profile-hero.png', 'public/assets/business-stages.png', 'public/assets/sample-ad.png', 'public/assets/strategy-operations.png', 'public/assets/leadership-growth.png', 'public/assets/marketing-content.png', 'public/assets/sales-relationships.png', 'public/assets/profile-branding.png', 'netlify/functions/auth-session.js', 'netlify/functions/member-eligibility.js', 'netlify/functions/prompts-list.js', 'netlify/functions/member-workspace.js', 'netlify/functions/assessment.js', 'netlify/functions/admin-console.js', 'netlify/functions/admin-member-import.js', 'netlify/functions/health.js', 'supabase/migrations/004_business_growth_platform.sql', 'supabase/migrations/005_business_growth_assessment.sql', 'supabase/migrations/006_identity_administration.sql', 'supabase/migrations/007_business_profile_experience.sql', 'supabase/migrations/008_visual_growth_experience.sql', 'supabase/migrations/010_context_aware_prompt_engine.sql', 'PRODUCT_VISION.md'];
required.push('public/assets/opportunities-procurement.png', 'netlify/functions/marketplace-list.js', 'netlify/functions/onboarding-state.js', 'supabase/migrations/011_business_growth_marketplace.sql', 'supabase/migrations/012_member_onboarding.sql', 'supabase/migrations/013_idempotent_platform_invitations.sql');
...
const jsFiles = [...fs.readdirSync(path.join(root, 'netlify/functions')).filter((name) => name.endsWith('.js')).map((name) => `netlify/functions/${name}`), 'public/prompt-engine.js', 'public/app.js', 'scripts/check-config.js', 'scripts/serve-static.js'];
